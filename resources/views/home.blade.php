...
<body>
    ...
    <div class="jumbotron">
        <div class="container">
            <p class="display-4"><span class="font-weight-bold">Selamat Datang di SIAKAD STTAB</span></p>
            <hr class="my-4">
            <a class="btn btn-Warning btn-lg font-weight-bold" href="/registrasi" role="button">Registrasi Sekarang</a>
        </div>
    </div>
